...
#define RZ_V2H_PLL_CONF(n)		(0x20 * (n))
...
static const struct cpg_core_clk r9a09g057_core_clks[] __initconst = {
	...
	DEF_RZV2H_SAMPLL(".pllcm33", CLK_PLLCM33, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLCM33)),
	...
	DEF_RZV2H_SAMPLL(".pllcln", CLK_PLLCLN, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLCLN)),
	...
	DEF_RZV2H_SAMPLL(".plldty", CLK_PLLDTY, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLDTY)),
	...
	DEF_RZV2H_SAMPLL(".pllca55", CLK_PLLCA55, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLCA55)),
	...
	DEF_RZV2H_SAMPLL(".pllvdo", CLK_PLLVDO, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLVDO)),
	...
	DEF_DIV(".pllvdo_isp", CLK_PLLVDO_ISP, CLK_PLLVDO,
		CDDIV3_DIVCTL0, dtable_2_64, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV(".pllvdo_isu", CLK_PLLVDO_ISU, CLK_PLLVDO,
		CDDIV3_DIVCTL0, dtable_2_64, CLK_DIVIDER_HIWORD_MASK),
	DEF_RZV2H_SAMPLL(".plleth", CLK_PLLETH, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLETH)),
	...
	DEF_RZV2H_SAMPLL(".plldsi", CLK_PLLDSI, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLDSI)),
	DEF_DIV(".plldsi_sdiv2", CLK_PLLDSI_SDIV2, CLK_PLLDSI,
		CSDIV1_DIVCTL2, dtable_2_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_RZV2H_SAMPLL(".plldrp", CLK_PLLDRP, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLDRP)),
	DEF_RZV2H_SAMPLL(".pllgpu", CLK_PLLGPU, CLK_EXTAL, RZ_V2H_PLL_CONF(PLLGPU)),
...
static struct rzg2l_mod_clk r9a09g057_mod_clks[] = {
	...
	DEF_MOD("gpt1_pclk_sfr",	R9A09G057_GPT1_PCLK_SFR, CLK_PLLCLN_DIV8,
					0x60C,	2, 0),
	DEF_MOD("mcpu_cmtw0_clkm",	R9A09G057_MCPU_CMTW0_CLKM, CLK_PLLCM33_DIV32,
					0x60C, 11, 0),
	DEF_MOD("mcpu_cmtw1_clkm",	R9A09G057_MCPU_CMTW1_CLKM, CLK_PLLCM33_DIV32,
					0x60C, 12, 0),
	DEF_MOD("mcpu_cmtw2_clkm",	R9A09G057_MCPU_CMTW2_CLKM, CLK_PLLCM33_DIV32,
					0x60C, 13, 0),
	DEF_MOD("mcpu_cmtw3_clkm",	R9A09G057_MCPU_CMTW3_CLKM, CLK_PLLCM33_DIV32,
					0x60C, 14, 0),
	DEF_MOD("rcpu_cmtw0_clkm",	R9A09G057_RCPU_CMTW0_CLKM, CLK_PLLCLN_DIV32,
					0x60C, 15, 0),
	DEF_MOD("rcpu_cmtw1_clkm",	R9A09G057_RCPU_CMTW1_CLKM, CLK_PLLCLN_DIV32,
					0x610,  0, 0),
	DEF_MOD("rcpu_cmtw2_clkm",	R9A09G057_RCPU_CMTW2_CLKM, CLK_PLLCLN_DIV32,
					0x610,  1, 0),
	DEF_MOD("rcpu_cmtw3_clkm",	R9A09G057_RCPU_CMTW3_CLKM, CLK_PLLCLN_DIV32,
					0x610,  2, 0),
	...
	DEF_MOD("cru3_m_xi",		R9A09G057_CRU3_M_XI, R9A09G057_MAINCLK,
					0x638, 1, 0),
	DEF_MOD("isp_reg_aclk",		R9A09G057_ISP_REG_ACLK, CLK_PLLDTY_ACPU_DIV2,
					0x638, 2, 0),
	DEF_MOD("isp_pclk",		R9A09G057_ISP_PCLK, CLK_PLLDTY_DIV16,
					0x638, 3, 0),
	DEF_MOD("isp_vin_aclk",		R9A09G057_ISP_VIN_ACLK, CLK_PLLDTY_ACPU_DIV2,
					0x638, 4, 0),
	DEF_MOD("isp_sclk",		R9A09G057_ISP_ISP_SCLK, CLK_PLLVDO_ISP,
					0x638, 5, 0),
...
static struct rzg2l_reset r9a09g057_resets[] = {
	...
	DEF_RST(R9A09G057_MCPU_CMTW0_RST_M,		0x918,  5),
	DEF_RST(R9A09G057_MCPU_CMTW1_RST_M,		0x918,  6),
	DEF_RST(R9A09G057_MCPU_CMTW2_RST_M,		0x918,  7),
	DEF_RST(R9A09G057_MCPU_CMTW3_RST_M,		0x918,  8),
	DEF_RST(R9A09G057_RCPU_CMTW0_RST_M,		0x918, 	9),
	DEF_RST(R9A09G057_RCPU_CMTW1_RST_M,		0x918, 10),
	DEF_RST(R9A09G057_RCPU_CMTW2_RST_M,		0x918, 11),
	DEF_RST(R9A09G057_RCPU_CMTW3_RST_M,		0x918, 12),
	...
	DEF_RST(R9A09G057_ISP_VIN_ARESETN,		0x934,	1),
	DEF_RST(R9A09G057_ISP_REG_ARESETN,		0x934,	2),
	DEF_RST(R9A09G057_ISP_ISP_SRESETN,		0x934,	3),
	DEF_RST(R9A09G057_ISP_PRESETN,			0x934,	4),
...
static struct clk_mon r9a09g057_clk_mon[] = {
	...
	DEF_CLK_MON(R9A09G057_MCPU_CMTW0_CLKM,		0x804,	27),
	DEF_CLK_MON(R9A09G057_MCPU_CMTW1_CLKM,		0x804,	28),
	DEF_CLK_MON(R9A09G057_MCPU_CMTW2_CLKM,		0x804,	29),
	DEF_CLK_MON(R9A09G057_MCPU_CMTW3_CLKM,		0x804,	30),
	DEF_CLK_MON(R9A09G057_RCPU_CMTW0_CLKM,		0x804,	31),
	DEF_CLK_MON(R9A09G057_RCPU_CMTW1_CLKM,		0x808,	 0),
	DEF_CLK_MON(R9A09G057_RCPU_CMTW2_CLKM,		0x808,	 1),
	DEF_CLK_MON(R9A09G057_RCPU_CMTW3_CLKM,		0x808,	 2),
	...
	DEF_CLK_MON(R9A09G057_ISP_REG_ACLK,		0x81C,	 2),
	DEF_CLK_MON(R9A09G057_ISP_PCLK,			0x81C,	 3),
	DEF_CLK_MON(R9A09G057_ISP_VIN_ACLK,		0x81C,	 4),
	DEF_CLK_MON(R9A09G057_ISP_ISP_SCLK,		0x81C,	 5),
...
static struct rst_mon r9a09g057_rst_mon[] = {
	...
	DEF_RST_MON(R9A09G057_MCPU_CMTW0_RST_M,		0xA08,  22),
	DEF_RST_MON(R9A09G057_MCPU_CMTW1_RST_M,		0xA08,  23),
	DEF_RST_MON(R9A09G057_MCPU_CMTW2_RST_M,		0xA08,  24),
	DEF_RST_MON(R9A09G057_MCPU_CMTW3_RST_M,		0xA08,  25),
	DEF_RST_MON(R9A09G057_RCPU_CMTW0_RST_M,		0xA08,  26),
	DEF_RST_MON(R9A09G057_RCPU_CMTW1_RST_M,		0xA08,  27),
	DEF_RST_MON(R9A09G057_RCPU_CMTW2_RST_M,		0xA08,  28),
	DEF_RST_MON(R9A09G057_RCPU_CMTW3_RST_M,		0xA08,  29),
	...
	DEF_RST_MON(R9A09G057_ISP_VIN_ARESETN,		0xA18,	 2),
	DEF_RST_MON(R9A09G057_ISP_REG_ARESETN,		0xA18,	 3),
	DEF_RST_MON(R9A09G057_ISP_ISP_SRESETN,		0xA18,	 4),
	DEF_RST_MON(R9A09G057_ISP_PRESETN,		0xA18,	 5),
...
const struct rzg2l_cpg_info r9a09g057_cpg_info = {
	...
	.num_hw_mod_clks = R9A09G057_ISP_ISP_SCLK + 1,

	/* Resets */
	.resets = r9a09g057_resets,
	.num_resets = R9A09G057_ISP_PRESETN + 1, /* Last reset ID + 1 */
	...
	.num_rst_mon = R9A09G057_ISP_PRESETN + 1,
};
